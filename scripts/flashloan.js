...
const mcdFlashLoanTakerAddr = '0xE676BB37163249cb4347495E1afbD501338c928b';
...
(async () => {
    ...
    await closeWithLoan(222, getTokenJoinAddr('ETH'), '1');
...
const closeWithLoan = async (cdpId, joinAddr, amount) => {
    try {
        amount = web3.utils.toWei(amount, 'ether');
