...
contract MonitorProxy {
    ...
    function subscribe(bytes32 _cup, uint _minRatio, uint _maxRatio, uint _optimalRatio, uint _slippageLimit, address _monitor) public {
        ...
        Monitor(_monitor).subscribe(_cup, _minRatio, _maxRatio, _optimalRatio, _slippageLimit);
    }
